...
def IASI_uncertainty():
	...
	return mar_sep_uncertaintyP, mar_uncertainty_mask, apr_uncertainty_mask, may_uncertainty_mask, jun_uncertainty_mask, jul_uncertainty_mask, aug_uncertainty_mask,sep_uncertainty_mask

	
mar_sep_uncertaintyP, mar_uncertainty_mask, apr_uncertainty_mask, may_uncertainty_mask, jun_uncertainty_mask, jul_uncertainty_mask, aug_uncertainty_mask,sep_uncertainty_mask = IASI_uncertainty()
...
ax.annotate('IASI NH$_3$ = {0:.2f}'.format(Mar_Sep_iasi_derivedNH3_emission_sum_sum1)+' Gg',xy=(0.41,0.001), xytext=(0, pad),
		xycoords='axes fraction', textcoords='offset points',
...
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'IASI_NAEI_andDifference_NH3emissionMar_Sep_after_quadrature50v2.png',bbox_inches='tight')
plt.show()
