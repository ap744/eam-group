...
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'IASI_derived_NH3emissionF11Where.png',bbox_inches='tight')
plt.show()
...
plt.subplots_adjust(left=0.05, bottom=0.07, right=0.98, top=0.97, wspace=0.25, hspace=0.05);
#plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'mon_mean_model_ratio_regrid_without_mask.png',bbox_inches='tight')   ##########	
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'NAEI_NH3_emissionF11Where.png',bbox_inches='tight')
plt.show()
...
plt.subplots_adjust(left=0.05, bottom=0.07, right=0.98, top=0.97, wspace=0.25, hspace=0.05);
#plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'mon_mean_model_ratio_regrid_without_mask.png',bbox_inches='tight')   ##########	
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'NAEI_IASI_difference_emissionF11Where.png',bbox_inches='tight')
plt.show()
