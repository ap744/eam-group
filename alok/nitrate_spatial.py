...
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'nitrate_GEOS-Chem_DEFRAspatial_annualwithoutScotland_scaleNH3_50percent.png',bbox_inches='tight')
...
ax.set_title('DEFRA and GEOS-Chem Particulate nitrate (mam)',fontsize=20)
PCM=ax.get_children()[2] #get the mappable, the 1st and the 2nd are the x and y axes
...
colorbar.ax.tick_params(labelsize=20) 
colorbar.ax.xaxis.label.set_size(21)
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'nitrate_GEOS-Chem_DEFRAspatial_mamwithoutScotland_scaleNH3_50percent.png',bbox_inches='tight')
...
ax.set_title('DEFRA and GEOS-Chem Particulate nitrate (jja)',fontsize=20)
PCM=ax.get_children()[2] #get the mappable, the 1st and the 2nd are the x and y axes
...
colorbar.ax.tick_params(labelsize=20) 
colorbar.ax.xaxis.label.set_size(21)
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'nitrate_GEOS-Chem_DEFRAspatial_jjawithoutScotland_scaleNH3_50percent.png',bbox_inches='tight')
...
ax.set_title('DEFRA and GEOS-Chem Particulate nitrate (son)',fontsize=20)
PCM=ax.get_children()[2] #get the mappable, the 1st and the 2nd are the x and y axes
...
colorbar.ax.tick_params(labelsize=20) 
colorbar.ax.xaxis.label.set_size(21)
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'nitrate_GEOS-Chem_DEFRAspatial_sonwithoutScotland_scaleNH3_50percent.png',bbox_inches='tight')
...
ax.set_title('DEFRA and GEOS-Chem Particulate nitrate (djf)',fontsize=20)
PCM=ax.get_children()[2] #get the mappable, the 1st and the 2nd are the x and y axes
...
colorbar.ax.tick_params(labelsize=20) 
colorbar.ax.xaxis.label.set_size(21)
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'nitrate_GEOS-Chem_DEFRAspatial_djfwithoutScotland_scaleNH3_50percent.png',bbox_inches='tight')
