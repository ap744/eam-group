...
def daily_data(month,day):
	...
	#nh3_sat_A = (nh3_sat*2.46*1e10)/bxheight1_sat
	
	
	nh3_sat_A = (nh3_sat/1e9)*airdensity1_sat#molucules/cm2
...
print(regridded_data_sat.shape,'regrid_sat_shape')
...
regridded_data_emission_uk_GC[regridded_data_emission_uk_GC <= 5] = np.nan
iind=60
jind=50
...
print(regridded_data_sat_uk[6,iind,jind],'!!!!!!!!!!!!print for gc column NH3!!!!!!!!!!!!!')
print (regridded_data_emission_uk_GC[6,iind,jind])

#calculation of GC ratio (NH3 column concentration / NH3 emission)
Jan_mon_mean_model_ratio = regridded_data_sat_uk[0,:,:]/regridded_data_emission_uk_GC[0,:,:]
Feb_mon_mean_model_ratio = regridded_data_sat_uk[1,:,:]/regridded_data_emission_uk_GC[1,:,:]
Mar_mon_mean_model_ratio = regridded_data_sat_uk[2,:,:]/regridded_data_emission_uk_GC[2,:,:]
Apr_mon_mean_model_ratio = regridded_data_sat_uk[3,:,:]/regridded_data_emission_uk_GC[3,:,:]
May_mon_mean_model_ratio = regridded_data_sat_uk[4,:,:]/regridded_data_emission_uk_GC[4,:,:]
Jun_mon_mean_model_ratio = regridded_data_sat_uk[5,:,:]/regridded_data_emission_uk_GC[5,:,:]
Jul_mon_mean_model_ratio = regridded_data_sat_uk[6,:,:]/regridded_data_emission_uk_GC[6,:,:]
Aug_mon_mean_model_ratio = regridded_data_sat_uk[7,:,:]/regridded_data_emission_uk_GC[7,:,:]
Sep_mon_mean_model_ratio = regridded_data_sat_uk[8,:,:]/regridded_data_emission_uk_GC[8,:,:]
Oct_mon_mean_model_ratio = regridded_data_sat_uk[9,:,:]/regridded_data_emission_uk_GC[9,:,:]
Nov_mon_mean_model_ratio = regridded_data_sat_uk[10,:,:]/regridded_data_emission_uk_GC[10,:,:]
Dec_mon_mean_model_ratio = regridded_data_sat_uk[11,:,:]/regridded_data_emission_uk_GC[11,:,:]
...
print (iasi_nh3_uk[6,iind,jind],'!!!!!!!!!!!!for iasi_nh3_uk!!!!!!!!!!!!!')
...
print (Jul_naei_nh3_emission[iind,jind],'!!!!!!!!!!!!!!!!!! for Jul_NAEI_Emission!!!!!!!!!!!!')
...
title_listA = 'NAEI (JAN_DEC) NH$_3$ emission (kg)'	
title_listB = 'IASI (JAN_DEC) NH$_3$ emission (kg)'	
title_listC = 'NAEI Rawdata NH$_3$ emission (kg)'	
title_list1 = 'JAN'
title_list2 = 'FEB'
title_list3 = 'MAR'
title_list4 = 'APR'
...
# Plot Figure 
fig = plt.figure(facecolor='White',figsize=[21,8]);pad= 1.1; 
#plt.suptitle(title_listC, fontsize = 35, y=1.001)

ax = plt.subplot(1,3,1);
plt.title(title_listA, fontsize =20, y=1)
colormap=cmap; colorbar_min=0;colorbar_max=8e5## change this accordingly
colormesh_1 = spatial_figure(ax,Jan_Dec_NAEI_sum,lon_naei_uk,lat_naei_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
...
colormap=cmap; colorbar_min=0;colorbar_max=8e5## change this accordingly
colormesh_1 = spatial_figure(ax,Jan_Dec_IASI_sum,lon_naei_uk,lat_naei_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('MAM',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
ax.annotate('IASI_derived = {0:.2f}'.format(IASI_total_emission),xy=(0.3,0.001), xytext=(0, pad),
		xycoords='axes fraction', textcoords='offset points',
		ha='center', va='bottom',rotation='horizontal',fontsize=15)

ax = plt.subplot(1,3,3);
plt.title(title_listC, fontsize = 20, y=1)
colormap=cmap; colorbar_min=0;colorbar_max=8e5## change this accordingly
...
# ax.annotate('MAM',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)
ax.annotate('NAEI_raw = {0:.2f}'.format(NAEI_total_emission_raw),xy=(0.3,0.001), xytext=(0, pad),
		xycoords='axes fraction', textcoords='offset points',
		ha='center', va='bottom',rotation='horizontal',fontsize=15)
...
cbar_ax.annotate(r'NH$_3$ Emission (kg)',xy=(0.5,0.9), xytext=(0, pad),
		xycoords='axes fraction', textcoords='offset points',
		ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'NAEI_IASI_sum_all_andNAEIrawA11.png',bbox_inches='tight')
plt.show()
