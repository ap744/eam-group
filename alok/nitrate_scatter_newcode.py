...
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'nitrate_GEOS-Chem_DEFRAscatter_annual_iccw.png',bbox_inches='tight')
#plt.show()
...
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'nitrate_GEOS-Chem_DEFRAscatter_seasonal_iccw.png',bbox_inches='tight')
plt.show()
