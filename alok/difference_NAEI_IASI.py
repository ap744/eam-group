...
############################ IASI after NAEI Mask ##################################


"""iasi_derived_NH3_emission_JAN = iasi_derived_NH3_emission_JAN.copy() * mask_UK
iasi_derived_NH3_emission_FEB = iasi_derived_NH3_emission_FEB.copy() * mask_UK
iasi_derived_NH3_emission_MAR = iasi_derived_NH3_emission_MAR.copy() * mask_UK
iasi_derived_NH3_emission_APR = iasi_derived_NH3_emission_APR.copy() * mask_UK
iasi_derived_NH3_emission_MAY = iasi_derived_NH3_emission_MAY.copy() * mask_UK
iasi_derived_NH3_emission_JUN = iasi_derived_NH3_emission_JUN.copy() * mask_UK
iasi_derived_NH3_emission_JUL = iasi_derived_NH3_emission_JUL.copy() * mask_UK
iasi_derived_NH3_emission_AUG = iasi_derived_NH3_emission_AUG.copy() * mask_UK
iasi_derived_NH3_emission_SEP = iasi_derived_NH3_emission_SEP.copy() * mask_UK
iasi_derived_NH3_emission_OCT = iasi_derived_NH3_emission_OCT.copy() * mask_UK
iasi_derived_NH3_emission_NOV = iasi_derived_NH3_emission_NOV.copy() * mask_UK
iasi_derived_NH3_emission_DEC = iasi_derived_NH3_emission_DEC.copy() * mask_UK"""
...
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'IASI_derived_NH3emissionF1.png',bbox_inches='tight')
plt.show()
...
plt.subplots_adjust(left=0.05, bottom=0.07, right=0.98, top=0.97, wspace=0.25, hspace=0.05);
#plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'mon_mean_model_ratio_regrid_without_mask.png',bbox_inches='tight')   ##########	
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'NAEI_IASI_difference_emission1F.png',bbox_inches='tight')
plt.show()
