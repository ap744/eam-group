...
regridded_data_emission[regridded_data_emission <= 250] = np.nan
...
title_list = 'Monthly Mean GC ratio (NH$_3$ column conc/emission) 0.1 x 0.1'					###########
title_list1 = 'JAN'
title_list2 = 'FEB'
title_list3 = 'MAR'
title_list4 = 'APR'
...
colormesh_1 = spatial_figure(ax,Jan_mon_mean_model_ratio,lon01,lat01,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
...
colormap=cmap; colorbar_min=0.5e20;colorbar_max=5e21## change this accordingly
colormesh_1 = spatial_figure(ax,Feb_mon_mean_model_ratio,lon01,lat01,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('MAM',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
colormap=cmap; colorbar_min=0.5e20;colorbar_max=5e21 ## change this accordingly
colormesh_1 = spatial_figure(ax,Mar_mon_mean_model_ratio,lon01,lat01,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('MAM',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
colormap=cmap; colorbar_min=0.5e20;colorbar_max=5e21  ## change this accordingly
colormesh_1 = spatial_figure(ax,Apr_mon_mean_model_ratio,lon01,lat01,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
...
colormap=cmap; colorbar_min=0.5e20;colorbar_max=5e21  ## change this accordingly
colormesh_1 = spatial_figure(ax,May_mon_mean_model_ratio,lon01,lat01,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('JJA',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
colormap=cmap; colorbar_min=0.5e20;colorbar_max=5e21  ## change this accordingly
colormesh_1 = spatial_figure(ax,Jun_mon_mean_model_ratio,lon01,lat01,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('JJA',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
colormap=cmap; colorbar_min=0.5e20;colorbar_max=5e21  ## change this accordingly
colormesh_1 = spatial_figure(ax,Jul_mon_mean_model_ratio,lon01,lat01,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
...
colormap=cmap; colorbar_min=0.5e20;colorbar_max=5e21  ## change this accordingly
colormesh_1 = spatial_figure(ax,Aug_mon_mean_model_ratio,lon01,lat01,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('SON',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
colormap=cmap; colorbar_min=0.5e20;colorbar_max=5e21  ## change this accordingly
colormesh_1 = spatial_figure(ax,Sep_mon_mean_model_ratio,lon01,lat01,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('SON',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
colormap=cmap;colorbar_min=0.5e20;colorbar_max=5e21 ## change this accordingly
colormesh_1 = spatial_figure(ax,Oct_mon_mean_model_ratio,lon01,lat01,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
...
colormap=cmap; colorbar_min=0.5e20;colorbar_max=5e21 ## change this accordingly
colormesh_1 = spatial_figure(ax,Nov_mon_mean_model_ratio,lon01,lat01,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('DJF',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
colormap=cmap; colorbar_min=0.5e20;colorbar_max=5e21 ## change this accordingly
colormesh_1 = spatial_figure(ax,Dec_mon_mean_model_ratio,lon01,lat01,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('DJF',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'mon_mean_model_ratio_regrid_with_ocean_mask.png',bbox_inches='tight')
plt.show()
