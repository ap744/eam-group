...
x11 = NH3_NH4_annual_model
y11 = NH3_NH4_annual_sites
print (x11)
print (y11)
...
x22 = NH3_NH4_mam_model
y22 = NH3_NH4_mam_sites
print (x22,'x22')
print (y22,'y22')
...
x33 = NH3_NH4_jja_model
y33 = NH3_NH4_jja_sites
x33a=np.array([x33,y33])
x33b = x33a[:,~np.isnan(x33a).any(axis=0)]
x3 = x33b[0]
y3 = x33b[1]

x44 = NH3_NH4_son_model
y44 = NH3_NH4_son_sites
x44a=np.array([x44,y44])
x44b = x44a[:,~np.isnan(x44a).any(axis=0)]
x4 = x44b[0]
y4 = x44b[1]

x55 = NH3_NH4_djf_model
y55 = NH3_NH4_djf_sites
...
#scatter plot 
title_list = 'DEFRA and GEOS-Chem NH3/NH4'
title_list1 = 'DEFRA & GEOS-Chem NH3/NH4 Annual'
title_list2 = 'DEFRA & GEOS-Chem NH3/NH4 MAM'
title_list3 = 'DEFRA & GEOS-Chem NH3/NH4 JJA'
title_list4 = 'DEFRA & GEOS-Chem NH3/NH4 SON'
title_list5 = 'DEFRA & GEOS-Chem NH3/NH4 DJF'
...
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'NH3andNH4ratioGEOS-Chem_DEFRAscatter_annual_bootstrap.png',bbox_inches='tight')
#plt.show()
...
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'NH3andNH4ratioGEOS-Chem_DEFRAscatter_seasonal_bootstrap.png',bbox_inches='tight')
plt.show()
