...
#correlation
correlate_annual=stats.pearsonr(sites_ammonia_AM,sites_ammonium_AM)

# dropping nan values and compute correlation
nas_mam = np.logical_or(np.isnan(sites_ammonia_mam), np.isnan(sites_ammonium_mam))
correlate_mam = stats.pearsonr(sites_ammonia_mam[~nas_mam],sites_ammonium_mam[~nas_mam])

nas_jja = np.logical_or(np.isnan(sites_ammonia_jja), np.isnan(sites_ammonium_jja))
correlate_jja = stats.pearsonr(sites_ammonia_jja[~nas_jja],sites_ammonium_jja[~nas_jja])

nas_son = np.logical_or(np.isnan(sites_ammonia_son), np.isnan(sites_ammonium_son))
correlate_son = stats.pearsonr(sites_ammonia_son[~nas_son],sites_ammonium_son[~nas_son])

nas_djf = np.logical_or(np.isnan(sites_ammonia_djf), np.isnan(sites_ammonium_djf))
correlate_djf = stats.pearsonr(sites_ammonia_djf[~nas_djf],sites_ammonium_djf[~nas_djf])
...
#scatter plot 
title_list = 'DEFRA NH3 and NH4'
title_list1 = 'DEFRA NH3 and NH4 Annual'
title_list2 = 'DEFRA NH3 and NH4 MAM'
title_list3 = 'DEFRA NH3 and NH4 JJA'
title_list4 = 'DEFRA NH3 and NH4 SON'
title_list5 = 'DEFRA NH3 and NH4 DJF'
...
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'DEFRA_NH3andNH4comparisonscatter_annual_bootstrap.png',bbox_inches='tight')
#plt.show()
...
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'DEFRA_NH3andNH4comparisonscatter_seasonal_bootstrap.png',bbox_inches='tight')
plt.show()
