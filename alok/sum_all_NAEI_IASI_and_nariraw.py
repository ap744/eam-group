...
print (regridded_data_emission_uk_iasi[6,iind,jind])
...
print (Jul_naei_nh3_emission[iind,jind],'!!!!!!!!!!!!!!!!!! for Jul_naei!!!!!!!!!!!!')
...
colormap=cmap; colorbar_min=0;colorbar_max=2e5## change this accordingly
...
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'NAEI_IASI_sum_all_andNAEIrawA.png',bbox_inches='tight')
plt.show()
