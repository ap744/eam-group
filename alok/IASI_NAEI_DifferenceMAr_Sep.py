...
Mar_Sep_iasi_derivedNH3_emission_sum_sum = np.nansum(np.nansum(Mar_Sep_iasi_derivedNH3_emission_sum,axis=1),axis=0)/1000
...
Mar_Sep_naei_NH3_emission_sum_sum = np.nansum(np.nansum(Mar_Sep_naei_NH3_emission_sum,axis=1),axis=0)/1000
...
colormesh_1 = spatial_figure(ax,Mar_Sep_iasi_derivedNH3_emission_sum,lon_gc_uk,lat_gc_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
...
colormap=cmap; colorbar_min=0;colorbar_max=150## change this accordingly
colormesh_1 = spatial_figure(ax,Mar_Sep_naei_NH3_emission_sum,lon_naei_uk,lat_naei_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('MAM',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
colormesh_1 = spatial_figure(ax,Diff_Mar_Sep_NAEI_IASI,lon_naei_uk,lat_naei_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('MAM',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'IASI_NAEI_andDifference_NH3emissionMar_Sep.png',bbox_inches='tight')
plt.show()
