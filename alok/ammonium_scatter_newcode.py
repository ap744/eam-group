...
#ind=np.where((gc_data_ammonium_annual!=0)&(sites_ammonium_AM!=0))
#print (ind)
...
#scatter plot 
title_list = 'DEFRA and GEOS-Chem ammonium'
...
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'ammonium_GEOS-Chem_DEFRAscatter_annual_scaleNH3_50percent.png',bbox_inches='tight')
#plt.show()
...
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'ammonium_GEOS-Chem_DEFRAscatter_seasonal_scaleNH3_50percent.png',bbox_inches='tight')
plt.show()
