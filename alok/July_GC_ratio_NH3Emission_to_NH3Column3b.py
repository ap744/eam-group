...
ax.annotate('ratio_GC_emission_Column_total = {0:.3f}'.format(ratio_GC_emission_Column_total),xy=(0.3,0.001), xytext=(0, pad),
		xycoords='axes fraction', textcoords='offset points',
...
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'GCratioNH3Emission_to_NH3Column_July3.png',bbox_inches='tight')
plt.show()
