...
#regres=rma(gc_data_HONO,sites_HONO_AM,1000)
...
title_list1 = 'Spatial Map DEFRA and GEOS-Chem HONO'
...
ax.set_title('DEFRA and GEOS-Chem HONO (Annual)')
...
ax.set_title('DEFRA and GEOS-Chem HONO (mam)')
PCM=ax.get_children()[2] #get the mappable, the 1st and the 2nd are the x and y axes
...
ax.set_title('DEFRA and GEOS-Chem HONO (jja)')
PCM=ax.get_children()[2] #get the mappable, the 1st and the 2nd are the x and y axes
...
ax.set_title('DEFRA and GEOS-Chem HONO (son)')
PCM=ax.get_children()[2] #get the mappable, the 1st and the 2nd are the x and y axes
...
ax.set_title('DEFRA and GEOS-Chem HONO (djf)')
PCM=ax.get_children()[2] #get the mappable, the 1st and the 2nd are the x and y axes
