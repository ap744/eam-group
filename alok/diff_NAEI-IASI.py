...
title_listC = 'NAEI - IASI NH$_3$ emission (kg)'	
title_list1 = 'JAN'
title_list2 = 'FEB'
title_list3 = 'MAR'
title_list4 = 'APR'
...
colormap=cmap1; colorbar_min=-1e4;colorbar_max=1e4## change this accordingly
...
cbar_ax.annotate(r'NAEI - IASI',xy=(0.5,0.9), xytext=(0, pad),
		xycoords='axes fraction', textcoords='offset points',
		ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'NAEI_IASI_emission1F.png',bbox_inches='tight')
plt.show()
