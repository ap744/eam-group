...
Jan_Dec_NAEI_sum = Jan_Dec_NAEI_sum*mask_UK
...
Jan_Dec_IASI_sum[Jan_Dec_IASI_sum<50]=np.nan

Jan_Dec_IASI_sum = Jan_Dec_IASI_sum*mask_UK
print (Jan_Dec_IASI_sum.shape,'datashape')

IASI_total_emission = np.nansum(np.nansum(Jan_Dec_IASI_sum,axis=1),axis=0)
print (IASI_total_emission,'IASI_total_emission')

################# Scatter Plot ##################
Jan_Dec_IASI_sum_1d= Jan_Dec_IASI_sum.flatten()
Jan_Dec_NAEI_sum_1d= Jan_Dec_NAEI_sum.flatten() #.reshape(13482)

x11 = Jan_Dec_NAEI_sum_1d
y11 = Jan_Dec_IASI_sum_1d
print (x11.shape)
print (y11.shape)
...
plt.xlabel("NAEI NH$_3$ (kg)", fontsize = 20)
plt.ylabel("IASI NH$_3$ (kg)", fontsize = 20)
...
plt.text(5.1e4,8.7e4,add2plt, fontsize=16,\
		ha='left', va='center')#, transform=ax.transAxes)
add2plt=("R$^2$ = {a:6.2f}".format(a=correlate_annual[0]*correlate_annual[0]))
plt.text(5.1e4,8.4e4, add2plt, fontsize=16,\
		ha='left', va='center')#, transform=ax.transAxes)
add2plt=("r = {a:6.2f}".format(a=r_value1))
plt.text(5.1e4,8.1e4, add2plt, fontsize=16,\
		ha='left', va='center')#, transform=ax.transAxes)
...
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'NAEI_IASI_NH3_Scatter.png',bbox_inches='tight')
plt.show()
