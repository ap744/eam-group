...
quadrature_mask[quadrature_mask <=50] = 1
quadrature_mask[quadrature_mask >50] = np.nan
...
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'IASI_NAEI_andDifference_NH3emissionMar_Sep_after_quadrature50.png',bbox_inches='tight')
plt.show()
