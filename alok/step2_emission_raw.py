...
title_list = 'NH$_3$ Emission Original 0.25 x 0.3125'					###########
title_list1 = 'JAN'
title_list2 = 'FEB'
title_list3 = 'MAR'
title_list4 = 'APR'
...
colormesh_1 = spatial_figure(ax,cube1[0,:,:].data,lon_o,lat_o,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True)
...
colormap=cmap; colorbar_min=1e-07;colorbar_max=1e-02## change this accordingly
colormesh_1 = spatial_figure(ax,cube1[1,:,:].data,lon_o,lat_o,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True)
# ax.annotate('MAM',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
colormap=cmap; colorbar_min=1e-07;colorbar_max=1e-02## change this accordingly
colormesh_1 = spatial_figure(ax,cube1[2,:,:].data,lon_o,lat_o,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True)
# ax.annotate('MAM',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
colormap=cmap; colorbar_min=1e-07;colorbar_max=1e-02 ## change this accordingly
colormesh_1 = spatial_figure(ax,cube1[3,:,:].data,lon_o,lat_o,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True)
...
colormap=cmap; colorbar_min=1e-07;colorbar_max=1e-02 ## change this accordingly
colormesh_1 = spatial_figure(ax,cube1[4,:,:].data,lon_o,lat_o,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True)
# ax.annotate('JJA',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
colormap=cmap; colorbar_min=1e-07;colorbar_max=1e-02 ## change this accordingly
colormesh_1 = spatial_figure(ax,cube1[5,:,:].data,lon_o,lat_o,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True)
# ax.annotate('JJA',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
colormap=cmap; colorbar_min=1e-07;colorbar_max=1e-02 ## change this accordingly
colormesh_1 = spatial_figure(ax,cube1[6,:,:].data,lon_o,lat_o,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True)
...
colormap=cmap; colorbar_min=1e-07;colorbar_max=1e-02 ## change this accordingly
colormesh_1 = spatial_figure(ax,cube1[7,:,:].data,lon_o,lat_o,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True)
# ax.annotate('SON',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
colormap=cmap; colorbar_min=1e-07;colorbar_max=1e-02 ## change this accordingly
colormesh_1 = spatial_figure(ax,cube1[8,:,:].data,lon_o,lat_o,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True)
# ax.annotate('SON',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
colormap=cmap;colorbar_min=1e-07;colorbar_max=1e-02## change this accordingly
colormesh_1 = spatial_figure(ax,cube1[9,:,:].data,lon_o,lat_o,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True)
...
colormap=cmap; colorbar_min=1e-07;colorbar_max=1e-02## change this accordingly
colormesh_1 = spatial_figure(ax,cube1[10,:,:].data,lon_o,lat_o,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True)
# ax.annotate('DJF',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
colormap=cmap; colorbar_min=1e-07;colorbar_max=1e-02## change this accordingly
colormesh_1 = spatial_figure(ax,cube1[11,:,:].data,lon_o,lat_o,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True)
# ax.annotate('DJF',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'raw_emission.png',bbox_inches='tight')   ##########	
plt.show()
