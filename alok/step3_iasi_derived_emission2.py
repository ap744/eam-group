...
regridded_data_emission_uk = regridded_data_emission[:,172:279,50:176]
print (regridded_data_emission_uk.shape , 'regridded_data_emission_uk.shape')

#mask low emission mainly over ocean
regridded_data_emission_uk[regridded_data_emission_uk <= 100] = np.nan
...
Jan_mon_mean_model_ratio = regridded_data_sat_uk[0,:,:]/regridded_data_emission_uk[0,:,:]
Feb_mon_mean_model_ratio = regridded_data_sat_uk[1,:,:]/regridded_data_emission_uk[1,:,:]
Mar_mon_mean_model_ratio = regridded_data_sat_uk[2,:,:]/regridded_data_emission_uk[2,:,:]
Apr_mon_mean_model_ratio = regridded_data_sat_uk[3,:,:]/regridded_data_emission_uk[3,:,:]
May_mon_mean_model_ratio = regridded_data_sat_uk[4,:,:]/regridded_data_emission_uk[4,:,:]
Jun_mon_mean_model_ratio = regridded_data_sat_uk[5,:,:]/regridded_data_emission_uk[5,:,:]
Jul_mon_mean_model_ratio = regridded_data_sat_uk[6,:,:]/regridded_data_emission_uk[6,:,:]
Aug_mon_mean_model_ratio = regridded_data_sat_uk[7,:,:]/regridded_data_emission_uk[7,:,:]
Sep_mon_mean_model_ratio = regridded_data_sat_uk[8,:,:]/regridded_data_emission_uk[8,:,:]
Oct_mon_mean_model_ratio = regridded_data_sat_uk[9,:,:]/regridded_data_emission_uk[9,:,:]
Nov_mon_mean_model_ratio = regridded_data_sat_uk[10,:,:]/regridded_data_emission_uk[10,:,:]
Dec_mon_mean_model_ratio = regridded_data_sat_uk[11,:,:]/regridded_data_emission_uk[11,:,:]
...
annual_emission = np.nansum(regridded_data_emission_uk.data[:], axis=0)

#monthly scale factor
Jan_scale_factor = regridded_data_emission_uk[0,:,:]/annual_emission #unit - unitless(kg/kg from GC model)
Feb_scale_factor = regridded_data_emission_uk[1,:,:]/annual_emission
Mar_scale_factor = regridded_data_emission_uk[2,:,:]/annual_emission
Apr_scale_factor = regridded_data_emission_uk[3,:,:]/annual_emission
May_scale_factor = regridded_data_emission_uk[4,:,:]/annual_emission
Jun_scale_factor = regridded_data_emission_uk[5,:,:]/annual_emission
Jul_scale_factor = regridded_data_emission_uk[6,:,:]/annual_emission
Aug_scale_factor = regridded_data_emission_uk[7,:,:]/annual_emission
Sep_scale_factor = regridded_data_emission_uk[8,:,:]/annual_emission
Oct_scale_factor = regridded_data_emission_uk[9,:,:]/annual_emission
Nov_scale_factor = regridded_data_emission_uk[10,:,:]/annual_emission
Dec_scale_factor = regridded_data_emission_uk[11,:,:]/annual_emission
...
naei_nh3_uk = naei_nh3[7:114,4:130]
...
title_listA = 'IASI derived NH$_3$ emission (kg)'	
title_list1 = 'JAN'
title_list2 = 'FEB'
title_list3 = 'MAR'
title_list4 = 'APR'
...
colormesh_1 = spatial_figure(ax,Jan_iasi_nh3_emission,lon_naei_uk,lat_naei_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
...
colormap=cmap; colorbar_min=0;colorbar_max=1e4## change this accordingly
colormesh_1 = spatial_figure(ax,Feb_iasi_nh3_emission,lon_naei_uk,lat_naei_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('MAM',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
colormap=cmap; colorbar_min=0;colorbar_max=1e4 ## change this accordingly
colormesh_1 = spatial_figure(ax,Mar_iasi_nh3_emission,lon_naei_uk,lat_naei_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('MAM',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
colormap=cmap; colorbar_min=0;colorbar_max=1e4  ## change this accordingly
colormesh_1 = spatial_figure(ax,Apr_iasi_nh3_emission,lon_naei_uk,lat_naei_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
...
colormap=cmap; colorbar_min=0;colorbar_max=1e4  ## change this accordingly
colormesh_1 = spatial_figure(ax,May_iasi_nh3_emission,lon_naei_uk,lat_naei_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('JJA',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
colormap=cmap; colorbar_min=0;colorbar_max=1e4  ## change this accordingly
colormesh_1 = spatial_figure(ax,Jun_iasi_nh3_emission,lon_naei_uk,lat_naei_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('JJA',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
colormap=cmap; colorbar_min=0;colorbar_max=1e4  ## change this accordingly
colormesh_1 = spatial_figure(ax,Jul_iasi_nh3_emission,lon_naei_uk,lat_naei_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
...
colormap=cmap; colorbar_min=0;colorbar_max=1e4  ## change this accordingly
colormesh_1 = spatial_figure(ax,Aug_iasi_nh3_emission,lon_naei_uk,lat_naei_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('SON',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
colormap=cmap; colorbar_min=0;colorbar_max=1e4  ## change this accordingly
colormesh_1 = spatial_figure(ax,Sep_iasi_nh3_emission,lon_naei_uk,lat_naei_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('SON',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
colormap=cmap;colorbar_min=0;colorbar_max=1e4 ## change this accordingly
colormesh_1 = spatial_figure(ax,Oct_iasi_nh3_emission,lon_naei_uk,lat_naei_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
...
colormap=cmap; colorbar_min=0;colorbar_max=1e4 ## change this accordingly
colormesh_1 = spatial_figure(ax,Nov_iasi_nh3_emission,lon_naei_uk,lat_naei_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('DJF',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
colormap=cmap; colorbar_min=0;colorbar_max=1e4 ## change this accordingly
colormesh_1 = spatial_figure(ax,Dec_iasi_nh3_emission,lon_naei_uk,lat_naei_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('DJF',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
cbar_ax.annotate(r'IASI NH$_3$',xy=(0.5,0.9), xytext=(0, pad),
		xycoords='axes fraction', textcoords='offset points',
		ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'IASI_derived_emissionF.png',bbox_inches='tight')
plt.show()
