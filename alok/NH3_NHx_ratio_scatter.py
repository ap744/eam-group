...
x11 = NH3NHxRatio_model_annual
y11 = NH3NHxRatio_sites_annual
print (x11)
print (y11)
...
x22 = NH3NHxRatio_model_mam
y22 = NH3NHxRatio_sites_mam
print (x22,'x22')
print (y22,'y22')
...
x33 = NH3NHxRatio_model_jja
y33 = NH3NHxRatio_sites_jja
x33a=np.array([x33,y33])
x33b = x33a[:,~np.isnan(x33a).any(axis=0)]
x3 = x33b[0]
y3 = x33b[1]

x44 = NH3NHxRatio_model_son
y44 = NH3NHxRatio_sites_son
x44a=np.array([x44,y44])
x44b = x44a[:,~np.isnan(x44a).any(axis=0)]
x4 = x44b[0]
y4 = x44b[1]

x55 = NH3NHxRatio_model_djf
y55 = NH3NHxRatio_sites_djf
