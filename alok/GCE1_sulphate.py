...
GC_surface_sulfate_AM.plot(ax=ax,cmap=cmap,vmin = 0,vmax =1,
...
ax.set_title('DEFRA and GEOS-Chem Particulate sulfate (Annual)',fontsize=25)
...
colorbar = plt.colorbar(PCM, ax=ax,label='GEOS-Chem & DEFRA sulfate ($\mu$g m$^{-3}$)',
