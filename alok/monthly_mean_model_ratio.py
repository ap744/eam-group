...
Jan_sat = sat_mon_mean[0,:,:]
print (Jan_sat.shape, 'Jan_sat.shape')
print (Jan_sat, 'Jan_sat')

Jan_emission = emission_mon_mean[0,:,:]
print (Jan_emission.shape, 'Jan_emission.shape')
print (Jan_emission, 'Jan_emission')
Jan_mon_mean_model_ratio = sat_mon_mean[0,:,:]/emission_mon_mean[0,:,:]
print (Jan_mon_mean_model_ratio.shape, 'Jan_mon_mean_model_ratio.shape')
print (Jan_mon_mean_model_ratio, 'Jan_mon_mean_model_ratio')
...
title_list = 'Monthly Mean Model ratio (satellite/emission)'					###########
title_list1 = 'JAN'
title_list2 = 'FEB'
title_list3 = 'MAR'
title_list4 = 'APR'
...
colormap=cmap; colorbar_min=0;colorbar_max=1e9## change this accordingly
colormesh_1 = spatial_figure(ax,Jan_mon_mean_model_ratio,lon_sat,lat_sat,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True)
...
colormap=cmap; colorbar_min=0;colorbar_max=1e9## change this accordingly
colormesh_1 = spatial_figure(ax,Feb_mon_mean_model_ratio,lon_sat,lat_sat,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True)
# ax.annotate('MAM',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
colormap=cmap; colorbar_min=0;colorbar_max=1e9 ## change this accordingly
colormesh_1 = spatial_figure(ax,Mar_mon_mean_model_ratio,lon_sat,lat_sat,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True)
# ax.annotate('MAM',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
colormap=cmap; colorbar_min=0;colorbar_max=1e9  ## change this accordingly
colormesh_1 = spatial_figure(ax,Apr_mon_mean_model_ratio,lon_sat,lat_sat,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True)
...
colormap=cmap; colorbar_min=0;colorbar_max=1e9  ## change this accordingly
colormesh_1 = spatial_figure(ax,May_mon_mean_model_ratio,lon_sat,lat_sat,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True)
# ax.annotate('JJA',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
colormap=cmap; colorbar_min=0;colorbar_max=1e9  ## change this accordingly
colormesh_1 = spatial_figure(ax,Jun_mon_mean_model_ratio,lon_sat,lat_sat,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True)
# ax.annotate('JJA',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
colormap=cmap; colorbar_min=0;colorbar_max=1e9  ## change this accordingly
colormesh_1 = spatial_figure(ax,Jul_mon_mean_model_ratio,lon_sat,lat_sat,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True)
...
colormap=cmap; colorbar_min=0;colorbar_max=1e9  ## change this accordingly
colormesh_1 = spatial_figure(ax,Aug_mon_mean_model_ratio,lon_sat,lat_sat,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True)
# ax.annotate('SON',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
colormap=cmap; colorbar_min=0;colorbar_max=1e9  ## change this accordingly
colormesh_1 = spatial_figure(ax,Sep_mon_mean_model_ratio,lon_sat,lat_sat,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True)
# ax.annotate('SON',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
colormap=cmap;colorbar_min=0;colorbar_max=1e9 ## change this accordingly
colormesh_1 = spatial_figure(ax,Oct_mon_mean_model_ratio,lon_sat,lat_sat,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True)
...
colormap=cmap; colorbar_min=0;colorbar_max=1e9 ## change this accordingly
colormesh_1 = spatial_figure(ax,Nov_mon_mean_model_ratio,lon_sat,lat_sat,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True)
# ax.annotate('DJF',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
colormap=cmap; colorbar_min=0;colorbar_max=1e9 ## change this accordingly
colormesh_1 = spatial_figure(ax,Dec_mon_mean_model_ratio,lon_sat,lat_sat,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True)
# ax.annotate('DJF',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
cbar_ax.annotate(r'model ratio',xy=(0.5,0.9), xytext=(0, pad),
		xycoords='axes fraction', textcoords='offset points',
		ha='center', va='bottom',rotation='horizontal',fontsize=30)	


plt.subplots_adjust(left=0.05, bottom=0.07, right=0.98, top=0.97, wspace=0.20, hspace=0.05);
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'mon_mean_model_ratio.png',bbox_inches='tight')   ##########	
plt.show()
