...
#############################################################################
annual_iasi_derivedNH3_emission = np.stack([iasi_derived_NH3_emission_JAN,iasi_derived_NH3_emission_FEB,iasi_derived_NH3_emission_MAR, iasi_derived_NH3_emission_APR, iasi_derived_NH3_emission_MAY,iasi_derived_NH3_emission_JUN,iasi_derived_NH3_emission_JUL,iasi_derived_NH3_emission_AUG,iasi_derived_NH3_emission_SEP, iasi_derived_NH3_emission_OCT,iasi_derived_NH3_emission_NOV, iasi_derived_NH3_emission_DEC])
print (annual_iasi_derivedNH3_emission.shape, 'annual_iasi_derivedNH3_emission.shape')
annual_iasi_derivedNH3_emission_sum = np.nansum(annual_iasi_derivedNH3_emission, axis=0)
print (annual_iasi_derivedNH3_emission_sum.shape, 'annual_iasi_derivedNH3_emission_sum')

annual_iasi_derivedNH3_emission_sum_sum = np.nansum(np.nansum(annual_iasi_derivedNH3_emission_sum,axis=1),axis=0)/1000
...
##################  annual NAEI Emission 
annual_naei_NH3_emission = np.stack([Jan_naei_nh3_emission, Feb_naei_nh3_emission, Mar_naei_nh3_emission, Apr_naei_nh3_emission, May_naei_nh3_emission,Jun_naei_nh3_emission,Jul_naei_nh3_emission,Aug_naei_nh3_emission,Sep_naei_nh3_emission,Oct_naei_nh3_emission,Nov_naei_nh3_emission,Dec_naei_nh3_emission])
print (annual_naei_NH3_emission.shape, 'annual_naei_NH3_emission.shape')
annual_naei_NH3_emission_sum = np.nansum(annual_naei_NH3_emission, axis=0)
print (annual_naei_NH3_emission_sum.shape, 'annual_naei_NH3_emission_sum')

annual_naei_NH3_emission_sum_sum = np.nansum(np.nansum(annual_naei_NH3_emission_sum,axis=1),axis=0)/1000
...
Diff_annual_NAEI_IASI = annual_naei_NH3_emission_sum - annual_iasi_derivedNH3_emission_sum
...
colormesh_1 = spatial_figure(ax,annual_iasi_derivedNH3_emission_sum,lon_gc_uk,lat_gc_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('MAM',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
ax.annotate('IASI NH$_3$ = {0:.2f}'.format(annual_iasi_derivedNH3_emission_sum_sum)+' Gg',xy=(0.41,0.001), xytext=(0, pad),
		xycoords='axes fraction', textcoords='offset points',
...
colormap=cmap; colorbar_min=0;colorbar_max=150## change this accordingly
colormesh_1 = spatial_figure(ax,annual_naei_NH3_emission_sum,lon_naei_uk,lat_naei_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('MAM',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
ax.annotate('NAEI NH$_3$ = {0:.2f}'.format(annual_naei_NH3_emission_sum_sum)+' Gg',xy=(0.41,0.001), xytext=(0, pad),
		xycoords='axes fraction', textcoords='offset points',
		ha='center', va='bottom',rotation='horizontal',fontsize=35, color='r')
...
colormesh_1 = spatial_figure(ax,Diff_annual_NAEI_IASI,lon_naei_uk,lat_naei_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('MAM',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'IASI_NAEI_andDifference_NH3emissionAnnual.png',bbox_inches='tight')
plt.show()
