...
regridded_data_emission_uk_iasi = regridded_data_emission[:,172:279,50:176]
regridded_data_emission_uk_naei = regridded_data_emission[:,172:279,50:176]
print (regridded_data_emission_uk_iasi.shape , 'regridded_data_emission_uk_iasi.shape')

#mask low emission mainly over ocean
regridded_data_emission_uk_iasi[regridded_data_emission_uk_iasi <= 100] = np.nan
...
Mar_Oct_NAEI = np.stack([Mar_naei_nh3_emission,Apr_naei_nh3_emission,May_naei_nh3_emission,Jun_naei_nh3_emission,Jul_naei_nh3_emission,Aug_naei_nh3_emission,Sep_naei_nh3_emission,Oct_naei_nh3_emission])
print (Mar_Oct_NAEI.shape)
Mar_Oct_NAEI_sum = np.nansum(Mar_Oct_NAEI, axis=0)
print (Mar_Oct_NAEI_sum.shape, 'naei sum')
Mar_Oct_NAEI_sum[Mar_Oct_NAEI_sum<500]=np.nan

Mar_Oct_IASI = np.array([Mar_iasi_nh3_emission,Apr_iasi_nh3_emission,May_iasi_nh3_emission,Jun_iasi_nh3_emission,Jul_iasi_nh3_emission,Aug_iasi_nh3_emission,Sep_iasi_nh3_emission,Oct_iasi_nh3_emission])
print (Mar_Oct_IASI.shape)
Mar_Oct_IASI_sum = np.nansum(Mar_Oct_IASI, axis=0)
print (Mar_Oct_IASI_sum.shape, 'IASI sum')
Mar_Oct_IASI_sum[Mar_Oct_IASI_sum<500]=np.nan
	
title_listA = 'NAEI (MAR - OCT) NH$_3$ emission (kg)'	
title_listB = 'IASI (MAR - OCT) NH$_3$ emission (kg)'	
title_list1 = 'JAN'
title_list2 = 'FEB'
title_list3 = 'MAR'
title_list4 = 'APR'
...
plt.title(title_listA, fontsize = 30, y=1)
colormap=cmap; colorbar_min=0;colorbar_max=1e5## change this accordingly
colormesh_1 = spatial_figure(ax,Mar_Oct_NAEI_sum,lon_naei_uk,lat_naei_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('MAM',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	

ax = plt.subplot(1,2,2);
plt.title(title_listB, fontsize = 30, y=1)
colormap=cmap; colorbar_min=0;colorbar_max=1e5## change this accordingly
colormesh_1 = spatial_figure(ax,Mar_Oct_IASI_sum,lon_naei_uk,lat_naei_uk,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True,bad_data=False)
# ax.annotate('MAM',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
cbar_ax.annotate(r'Mar-Oct NH$_3$ Emission (kg)',xy=(0.5,0.9), xytext=(0, pad),
		xycoords='axes fraction', textcoords='offset points',
		ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'NAEI_IASI_mar_oct_sumF1.png',bbox_inches='tight')
plt.show()
