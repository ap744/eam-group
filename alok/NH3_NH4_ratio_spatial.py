...
NH3_NH4_annual = GC_surface_ammonia_AM/GC_surface_ammonium_AM
NH3_NH4_mam = GC_surface_ammonia_mam/GC_surface_ammonium_mam
NH3_NH4_jja = GC_surface_ammonia_jja/GC_surface_ammonium_jja
NH3_NH4_son = GC_surface_ammonia_son/GC_surface_ammonium_son
NH3_NH4_djf = GC_surface_ammonia_djf/GC_surface_ammonium_djf
...
print (gc_data_ammonia_annual)
print (gc_data_ammonium_annual)


nmb_Annual=100.*((np.nanmean(NH3_NH4_annual_model))- np.nanmean(NH3_NH4_annual_sites))/np.nanmean(NH3_NH4_annual_sites)
nmb_mam=100.*((np.nanmean(NH3_NH4_mam_model))- np.nanmean(NH3_NH4_mam_sites))/np.nanmean(NH3_NH4_mam_sites)
nmb_jja=100.*((np.nanmean(NH3_NH4_jja_model))- np.nanmean(NH3_NH4_jja_sites))/np.nanmean(NH3_NH4_jja_sites)
nmb_son=100.*((np.nanmean(NH3_NH4_son_model))- np.nanmean(NH3_NH4_son_sites))/np.nanmean(NH3_NH4_son_sites)
nmb_djf=100.*((np.nanmean(NH3_NH4_djf_model))- np.nanmean(NH3_NH4_djf_sites))/np.nanmean(NH3_NH4_djf_sites)
...
#correlation
correlate_Annual=stats.pearsonr(NH3_NH4_annual_model,NH3_NH4_annual_sites)

# dropping nan values and compute correlation
nas_mam = np.logical_or(np.isnan(NH3_NH4_mam_model), np.isnan(NH3_NH4_mam_sites))
correlate_mam = stats.pearsonr(NH3_NH4_mam_model[~nas_mam],NH3_NH4_mam_sites[~nas_mam])

nas_jja = np.logical_or(np.isnan(NH3_NH4_jja_model), np.isnan(NH3_NH4_jja_sites))
correlate_jja = stats.pearsonr(NH3_NH4_jja_model[~nas_jja],NH3_NH4_jja_sites[~nas_jja])

nas_son = np.logical_or(np.isnan(NH3_NH4_son_model), np.isnan(NH3_NH4_son_sites))
correlate_son = stats.pearsonr(NH3_NH4_son_model[~nas_son],NH3_NH4_son_sites[~nas_son])

nas_djf = np.logical_or(np.isnan(NH3_NH4_djf_model), np.isnan(NH3_NH4_djf_sites))
correlate_djf = stats.pearsonr(NH3_NH4_djf_model[~nas_djf],NH3_NH4_djf_sites[~nas_djf])
...
NH3_NH4_annual.plot(ax=ax,cmap=cmap,vmin = 0,vmax =8,
								cbar_kwargs={'shrink': 0.5, 
											'pad' : 0.01,
											'label': 'NH3/NH4 GEOS-Chem',
											'orientation':'horizontal'})

ax.scatter(x=sites_lon, y=sites_lat,c=NH3_NH4_annual_sites,
		facecolors='none',edgecolors='black',linewidths=5,s = 100)
ax.scatter(x=sites_lon, y=sites_lat,c=NH3_NH4_annual_sites,
		cmap=cmap,s = 100,vmin = 0,vmax = 3)
		

ax.set_title('GEOS-Chem ammonia/ammonium (Annual)')
...
colorbar = plt.colorbar(PCM, ax=ax,label='NH3/NH4 DEFRA',
                       orientation='vertical',shrink=0.5,pad=0.01)
colorbar.ax.tick_params(labelsize=10) 
colorbar.ax.xaxis.label.set_size(10)
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'NH3_NH4_ratio_GeosChem_spatial_annual.png',bbox_inches='tight')
#plt.show()
...
NH3_NH4_mam.plot(ax=ax,cmap=cmap,vmin = 0,vmax =8,
								cbar_kwargs={'shrink': 0.5, 
											'pad' : 0.01,
											'label': 'NH3/NH4 GEOS-Chem',
											'orientation':'horizontal'})
											
ax.scatter(x=sites_lon, y=sites_lat,c=NH3_NH4_mam_sites,
		facecolors='none',edgecolors='black',linewidths=5,s = 100)
ax.scatter(x=sites_lon, y=sites_lat,c=NH3_NH4_mam_sites,
		cmap=cmap,s = 100,vmin = 0,vmax = 3)
		

ax.set_title('GEOS-Chem ammonia/ammonium (mam)')
PCM=ax.get_children()[2] #get the mappable, the 1st and the 2nd are the x and y axes


ax.annotate('Correl_Annual = {0:.2f}'.format(correlate_mam[0]),xy=(0.8,0.7), xytext=(0, pad),
		xycoords='axes fraction', textcoords='offset points',
		ha='center', va='bottom',rotation='horizontal',fontsize=15)
ax.annotate('NMB Annual= {0:.2f}'.format(nmb_mam),xy=(0.8,0.6), xytext=(0, pad),
		xycoords='axes fraction', textcoords='offset points',
		ha='center', va='bottom',rotation='horizontal',fontsize=15)
...
colorbar.ax.tick_params(labelsize=10) 
colorbar.ax.xaxis.label.set_size(10)
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'NH3_NH4_ratio_GeosChem_spatial_mam.png',bbox_inches='tight')
...
NH3_NH4_jja.plot(ax=ax,cmap=cmap,vmin = 0,vmax =8,
								cbar_kwargs={'shrink': 0.5, 
											'pad' : 0.01,
											'label': 'NH3/NH4 GEOS-Chem',
											'orientation':'horizontal'})
ax.scatter(x=sites_lon, y=sites_lat,c=NH3_NH4_jja_sites,
		facecolors='none',edgecolors='black',linewidths=5,s = 100)
ax.scatter(x=sites_lon, y=sites_lat,c=NH3_NH4_jja_sites,
		cmap=cmap,s = 100,vmin = 0,vmax = 3)
		

ax.set_title('GEOS-Chem ammonia/ammonium (jja)')
PCM=ax.get_children()[2] #get the mappable, the 1st and the 2nd are the x and y axes


ax.annotate('Correl_Annual = {0:.2f}'.format(correlate_jja[0]),xy=(0.8,0.7), xytext=(0, pad),
		xycoords='axes fraction', textcoords='offset points',
		ha='center', va='bottom',rotation='horizontal',fontsize=15)
ax.annotate('NMB Annual= {0:.2f}'.format(nmb_jja),xy=(0.8,0.6), xytext=(0, pad),
		xycoords='axes fraction', textcoords='offset points',
		ha='center', va='bottom',rotation='horizontal',fontsize=15)
...
colorbar.ax.tick_params(labelsize=10) 
colorbar.ax.xaxis.label.set_size(10)
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'NH3_NH4_ratio_GeosChem_spatial_jja.png',bbox_inches='tight')
...
NH3_NH4_son.plot(ax=ax,cmap=cmap,vmin = 0,vmax =8,
								cbar_kwargs={'shrink': 0.5, 
											'pad' : 0.01,
											'label': 'NH3/NH4 GEOS-Chem',
											'orientation':'horizontal'})
ax.scatter(x=sites_lon, y=sites_lat,c=NH3_NH4_son_sites,
		facecolors='none',edgecolors='black',linewidths=5,s = 100)
ax.scatter(x=sites_lon, y=sites_lat,c=NH3_NH4_son_sites,
		cmap=cmap,s = 100,vmin = 0,vmax = 3)
		

ax.set_title('GEOS-Chem ammonia/ammonium (son)')
PCM=ax.get_children()[2] #get the mappable, the 1st and the 2nd are the x and y axes


ax.annotate('Correl_Annual = {0:.2f}'.format(correlate_son[0]),xy=(0.8,0.7), xytext=(0, pad),
		xycoords='axes fraction', textcoords='offset points',
		ha='center', va='bottom',rotation='horizontal',fontsize=15)
ax.annotate('NMB Annual= {0:.2f}'.format(nmb_son),xy=(0.8,0.6), xytext=(0, pad),
		xycoords='axes fraction', textcoords='offset points',
		ha='center', va='bottom',rotation='horizontal',fontsize=15)
...
colorbar.ax.tick_params(labelsize=10) 
colorbar.ax.xaxis.label.set_size(10)
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'NH3_NH4_ratio_GeosChem_spatial_son.png',bbox_inches='tight')
...
NH3_NH4_djf.plot(ax=ax,cmap=cmap,vmin = 0,vmax =8,
								cbar_kwargs={'shrink': 0.5, 
											'pad' : 0.01,
											'label': 'NH3/NH4 GEOS-Chem',
											'orientation':'horizontal'})
ax.scatter(x=sites_lon, y=sites_lat,c=NH3_NH4_djf_sites,
		facecolors='none',edgecolors='black',linewidths=5,s = 100)
ax.scatter(x=sites_lon, y=sites_lat,c=NH3_NH4_djf_sites,
		cmap=cmap,s = 100,vmin = 0,vmax = 3)
		

ax.set_title('GEOS-Chem ammonia/ammonium (djf)')
PCM=ax.get_children()[2] #get the mappable, the 1st and the 2nd are the x and y axes


ax.annotate('Correl_Annual = {0:.2f}'.format(correlate_djf[0]),xy=(0.8,0.7), xytext=(0, pad),
		xycoords='axes fraction', textcoords='offset points',
		ha='center', va='bottom',rotation='horizontal',fontsize=15)
ax.annotate('NMB Annual= {0:.2f}'.format(nmb_djf),xy=(0.8,0.6), xytext=(0, pad),
		xycoords='axes fraction', textcoords='offset points',
		ha='center', va='bottom',rotation='horizontal',fontsize=15)
...
colorbar.ax.tick_params(labelsize=10) 
colorbar.ax.xaxis.label.set_size(10)
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'NH3_NH4_ratio_GeosChem_spatial_djf.png',bbox_inches='tight')
