...
emission_mon_total_july = emission_mon_total[6,:,:]/area_raw
print (emission_mon_total_july.shape, 'emission_mon_total_july.shape')
...
cube2 = Cube(emission_mon_total_july,
...
sum_regridded_emission  = np.nansum(np.nansum(regridded_data_emission.data,axis=1),axis=0)
...
sum_regridded_emission2  = np.nansum(np.nansum(regridded_data_emission2.data,axis=1),axis=0)
...
print (area_regid_uk.shape, 'area_regid_uk')


regridded_data_emission_july = regridded_data_emission_uk_GC*area_regid_uk
