...
print (regridded_data_emission_uk_GC.shape, 'emission_NH3_data')

july_total_NH3_emission = regridded_data_emission_uk_GC[6,:,:]  #1 kg
...
ratio_GC_emission_Column = (july_total_NH3_emission/July_GC_NH3_column)  #10$^{-10}$(kg/(molecules/cm$^2$)
...
iasi_derived_NH3_emission = (ratio_GC_emission_Column * July_IASI_column)/1000
...
ax.annotate('IASI_derived_Total_NH$_3$ = {0:.2f}'.format(iasi_derived_NH3_emission_total)+' tonnes',xy=(0.3,0.001), xytext=(0, pad),
		xycoords='axes fraction', textcoords='offset points',
...
cbar_ax.annotate(r'JULY IASI derived NH$_3$ Emission (tonnes) ',xy=(0.5,0.9), xytext=(0, pad),
		xycoords='axes fraction', textcoords='offset points',
		ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'iasi_derived_emissionJuly5.png',bbox_inches='tight')
plt.show()
