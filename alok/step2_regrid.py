...
title_list = 'NH$_3$ Emission Regridding 0.01 x 0.01'					###########
title_list1 = 'JAN'
title_list2 = 'FEB'
title_list3 = 'MAR'
title_list4 = 'APR'
...
colormesh_1 = spatial_figure(ax,regridded_data[0,:,:].data,lon_n,lat_n,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True)
...
colormap=cmap; colorbar_min=1e-07;colorbar_max=1e-02## change this accordingly
colormesh_1 = spatial_figure(ax,regridded_data[1,:,:].data,lon_n,lat_n,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True)
# ax.annotate('MAM',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
colormap=cmap; colorbar_min=1e-07;colorbar_max=1e-02## change this accordingly
colormesh_1 = spatial_figure(ax,regridded_data[2,:,:].data,lon_n,lat_n,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True)
# ax.annotate('MAM',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
colormap=cmap; colorbar_min=1e-07;colorbar_max=1e-02 ## change this accordingly
colormesh_1 = spatial_figure(ax,regridded_data[3,:,:].data,lon_n,lat_n,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True)
...
colormap=cmap; colorbar_min=1e-07;colorbar_max=1e-02 ## change this accordingly
colormesh_1 = spatial_figure(ax,regridded_data[4,:,:].data,lon_n,lat_n,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True)
# ax.annotate('JJA',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
colormap=cmap; colorbar_min=1e-07;colorbar_max=1e-02 ## change this accordingly
colormesh_1 = spatial_figure(ax,regridded_data[5,:,:].data,lon_n,lat_n,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True)
# ax.annotate('JJA',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
colormap=cmap; colorbar_min=1e-07;colorbar_max=1e-02 ## change this accordingly
colormesh_1 = spatial_figure(ax,regridded_data[6,:,:].data,lon_n,lat_n,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True)
...
colormap=cmap; colorbar_min=1e-07;colorbar_max=1e-02 ## change this accordingly
colormesh_1 = spatial_figure(ax,regridded_data[7,:,:].data,lon_n,lat_n,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True)
# ax.annotate('SON',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
colormap=cmap; colorbar_min=1e-07;colorbar_max=1e-02 ## change this accordingly
colormesh_1 = spatial_figure(ax,regridded_data[8,:,:].data,lon_n,lat_n,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True)
# ax.annotate('SON',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
colormap=cmap;colorbar_min=1e-07;colorbar_max=1e-02## change this accordingly
colormesh_1 = spatial_figure(ax,regridded_data[9,:,:].data,lon_n,lat_n,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True)
...
colormap=cmap; colorbar_min=1e-07;colorbar_max=1e-02## change this accordingly
colormesh_1 = spatial_figure(ax,regridded_data[10,:,:].data,lon_n,lat_n,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True)
# ax.annotate('DJF',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
colormap=cmap; colorbar_min=1e-07;colorbar_max=1e-02## change this accordingly
colormesh_1 = spatial_figure(ax,regridded_data[11,:,:].data,lon_n,lat_n,colormap,colorbar_min,colorbar_max,tb_lef=True,tb_bot=True)
# ax.annotate('DJF',xy=(0.07,0.90), xytext=(0, pad),
		# xycoords='axes fraction', textcoords='offset points',
		# ha='center', va='bottom',rotation='horizontal',fontsize=30)	
...
cbar_ax.annotate(r'GC_NH$_3$ emission (g/m2/month)',xy=(0.5,0.9), xytext=(0, pad),
		xycoords='axes fraction', textcoords='offset points',
		ha='center', va='bottom',rotation='horizontal',fontsize=30)	


plt.subplots_adjust(left=0.05, bottom=0.07, right=0.98, top=0.97, wspace=0.20, hspace=0.05);
plt.savefig('/scratch/uptrop/ap744/python_work/'+Today_date+'regrid_iris_emission.png',bbox_inches='tight')   ##########	
plt.show()
